    ...
    return (
        <div className="footer">
            <div className="container">
                <h4>reach us</h4>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam magnam id quasi tempora quam. Facilis.</p>
                <ul className="footer-info">
                    <li>
                        <FontAwesomeIcon icon={faPhone} />
                        <span>+01235599012 / +0123456789</span>
                    </li>
                    <li>
                        <FontAwesomeIcon icon={faLocationPin} />
                        <span>12a boubazar, kolkata, 700001</span>
                    </li>
                    <li>
                        <FontAwesomeIcon icon={faEnvelope} />
                        <span>relaxo@gmail.com</span>
                    </li>
                </ul>
